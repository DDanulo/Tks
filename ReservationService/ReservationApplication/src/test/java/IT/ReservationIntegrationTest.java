...
//                .header("Authorization", "Bearer " + token)
    ...
    private String createClientAndGetId() {
        // Tworzymy klienta z pominięciem REST API (bo tu nie ma już endpointu do tego)
        ClientEntity newClient = new ClientEntity();
        newClient.setUserId(ObjectId.get());
        newClient.setFirstName("John");
        newClient.setLastName("Doe");
        // newClient.setIsActive(true); // jeśli masz takie pole

        clientRepository.add(newClient);

        return newClient.getUserId().toString();
    }

    private void createReservation(String clientId, String roomId, int plusDays) {
...
//                .header("Authorization", "Bearer " + token)
    ...
    private String getFirstReservationIdForClient(String clientId) {
        return given()
//                .header("Authorization", "Bearer " + token)
...
//        String token = getAdminToken();
        ...
        createReservation( clientId, roomId, 2);

        String reservationId = getFirstReservationIdForClient( clientId);
...
//        String token = getAdminToken();
        ...
        createReservation(clientId, roomId, 5);
...
//        String token = getAdminToken();
        ...
        createReservation(clientId, roomId, 3);
...
//        String token = getAdminToken();
        ...
        createReservation(clientId, roomId, 1);
        String reservationId = getFirstReservationIdForClient(clientId);
...
//        String token = getAdminToken();
        ...
        createReservation( clientId, roomId, 10);
        String reservationId = getFirstReservationIdForClient( clientId);
