...
//    }
    ...
    private String createRoomAndGetId(RoomType type, int capacity, double price) {
...
//        String token = getAdminToken();
        String roomId = createRoomAndGetId(RoomType.HALL, 100, 500.0);
...
//        String token = getAdminToken();
        ...
        createRoomAndGetId(RoomType.FIELD, 22, 200.0);
        createRoomAndGetId( RoomType.COURT, 10, 120.0);
...
//        String token = getAdminToken();
        String roomId = createRoomAndGetId( RoomType.GYM, 20, 100.0);
...
//        String token = getAdminToken();
        String roomId = createRoomAndGetId( RoomType.HALL, 200, 1000.0);
