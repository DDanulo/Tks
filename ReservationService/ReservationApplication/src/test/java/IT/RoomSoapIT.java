...
public class RoomSoapIT {
    ...
    private WebServiceTemplate getAuthenticatedTemplate() {
...
//                connection.setRequestProperty("Authorization", "Bearer " + token);
    ...
    private String createTestRoomAndGetId(RoomType type, int capacity, double price) {
        ...
        WebServiceTemplate template = getAuthenticatedTemplate();
...
//        String token = getAdminToken();
        String roomId = createTestRoomAndGetId(RoomType.HALL, 100, 500.0);
