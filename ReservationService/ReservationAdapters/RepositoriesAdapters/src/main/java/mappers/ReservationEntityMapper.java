...
public class ReservationEntityMapper {
    ...
    public Reservation toReservation(ReservationEntity entity){
        ...
        ReservationClient user = userEntityMapper.EntityToUser(entity.getClientEntity());
        ...
        return Reservation.builder()
                ...
                .client((ReservationClient) user) // Cast to Client as per your Reservation domain
