...
public class MongoConfig {
    ...
    @Value("${spring.data.mongodb.uri:mongodb://admin:adminpassword@localhost:27018/reservations_db?authSource=admin}")
...
//                        .conventions(List.of(Conventions.ANNOTATION_CONVENTION))
    ...
    public MongoDatabase rentAFieldDB(MongoClient mongoClient) {
        return mongoClient.getDatabase("reservations_db");
    }
